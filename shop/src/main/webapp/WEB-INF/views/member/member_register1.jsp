...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/member/register1.css">
...
<body>
	...
	<section class="main-section-wrapper">
		<div class="main-section-container">
			<form method="POST" name="member" action="member_register2.shop" onsubmit="return joinCheck1()">
						...
						<div class="register-input-contents">
							<ol class="register-id-box">
								...
								<li class="register-id-input-wrapper">
									<input type="text" class="register-id-input" id="joinId" name="member" maxlength="12" placeholder="아이디 입력">
							...
							<ol class="register-pw-box">
								...
								<li class="register-pw-input-wrapper"><input
									...
									id="joinPw1" name="member" placeholder="비밀번호 입력">
							...
							<ol class="register-phone-box">
								<li class="register-phone-title">휴대폰 번호 <i class="fas fa-check" name="member" id="phoneCheckComplete"></i></li>
								<li class="register-phone-input-wrapper"><input
									type="text" maxlength="11" class="register-phone-input" 
									id="phoneNum" placeholder="휴대폰 번호 입력">
						...
						<div class="register-verify-contents-wrapper" id="beforeSending">
							...
							<div class="register-btn-wrapper">
								<input type="button" class="register-btn-wrapper-input" 
									value="본인 인증" name="member" onclick="joinCheck1()" >
							</div>
						</div>
						<div class="register-phone-input-verify-wrapper" id="afterSending">
							<div class="register-phone-input-verify-input-cover">
								<input type="text" class="register-phone-verify-input" name="member" placeholder="인증번호를 입력해주세요.">
							</div>
							<div class="register-btn-verify-wrapper">
								<input type="submit" class="register-btn-verify-wrapper-input" value="인증 번호 확인"  onclick="member_register2.shop">
							</div>
						</div>
					</div>
				</article>
