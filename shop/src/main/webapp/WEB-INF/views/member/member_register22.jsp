...
<%@ include file="../main/header.jsp" %>
	<section class="main-section-wrapper">
		<div class="main-section-container">
			<form method="POST" action="register_complete.shop"
				onsubmit="return joinCheck2()">
					...
					<div class="register-box-wrapper">
						<div class="register-input-contents">
							<ol class="register-nickname-box">
								...
								<input type="text" class="register-nickname-input" 
									id="nickname" name="nickname" 
									maxlength="12" placeholder="닉네임을 입력해주세요.">
							...
							<ol class="register-birth-box">
								...
								<input type="text" class="register-birth-input" id="birth" 
									name="birth"
									maxlength="6"
									placeholder="ex)021231"> - 
								<input type="password" maxlength="1" 
									class="register-birth-input-second" id="gender"
									name="gender">
									* * * * * *
