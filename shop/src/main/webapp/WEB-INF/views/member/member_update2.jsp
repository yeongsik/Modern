						...
						<div class="member-content-aritcle-section-container">
							<div class="member-content-article-section-info_area-wrapper">
								<div class="member-content-article-section-info_area">
									<div class="member-content-article-section-info_area-id">
										<div
											class="member-content-article-section-info_area-id-subtitle kor">아이디</div>
										<input type="text" value="${m.member_id}" name="member_id"
											readonly>
									</div>
									<button type="button" class="pw-button" id="pwbtn">비밀번호
										변경</button>
									<div class="member-content-article-section-info_area-pw"
										id="pwdivs">
										<div
											class="member-content-article-section-info_area-id-subtitle kor">새로운
											비밀번호</div>
									...
									<div class="member-content-article-section-info_area-nickname">
										<div
											class="member-content-article-section-info_area-id-subtitle kor">휴대폰
											번호</div>
									...
									<div class="member-content-article-section-info_area-email kor">
										...
										<input type="checkbox" id="accept_mail" name="accept_mail_value" value="${m.accept_mail}"> 마케팅 수신 동의 <br>
							...
							<div class="member-content-article-section-address_area">
								<div class="member-content-article-section-address_area-basic">
									...
									<div class="member-content-article-section-address_area-basic-btn kor">
										
									</div>
								</div>
								<div class="member-content-article-section-address_area-list">
									<div
										class="member-content-article-section-address_area-list-title kor">추가
										배송지</div>
									<div class="member-content-article-section-address_area-list-function kor">
										<button type="button" onclick="openDaumPostcode()">추가</button>
										<button type="button">삭제</button>
									</div>
									<c:forEach var="add1" items="${addlist}">
										<c:if test="${add1.address_state == 0 }">
											<div
												class="member-content-article-section-address_area-list-item">
												<div class="member-content-article-section-address_area-list-item-chk" id="typeCh">
													<input type="checkbox" name="chkbox" value="${add1.add_pk}">${add1.address1}
													${add1.address2 }
												</div>
											</div>
											<div class="member-content-article-section-info_area-id-subtitle kor">
												<!-- <input type="text" id="update_post" name="post" placeholder="우편번호">	<br>
												<input type="text" id="update_add1" name="address1" placeholder="주소">	<br>
												<input type="text" id="update_add2" name="address2" placeholder="상세주소"> -->
											</div>
										</c:if>
									</c:forEach>
								</div>
									<button type="button" id="addressButton">기본 배송지 변경</button>
							</div>
						</div>
					</div>
				</div>
