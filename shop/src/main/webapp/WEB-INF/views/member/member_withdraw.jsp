...
<body>
	<form action="member_withdraw.shop" onsubmit="return pwCheck1()" method="post">
				...
				<div class="member-content-main-container">
					...
					<div class="member-content-article-container">
						...
						<div class="member-content-article-inputarea">
							<div class="member-content-article-inputarea-comment kor">회원정보
								확인을 위해 비밀번호를 입력해주세요.</div>
							<input type="password" id="userpw" name="pw" class="member-content-article-inputarea-pw"> <input type="submit" 
							 class="member-content-article-inputarea-btn" value="확인">
